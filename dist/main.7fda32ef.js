...
$button1.on('click', function () {
    var n = parseInt($number.text()); //获取到number中的内容 并转为数字
    n += 1;
...
$tabBar.on('click', 'li', function (e) {
    var $li = (0, _jquery2.default)(e.currentTarget); //监听父元素同时可以知道点击的是哪个子元素
    $li.addClass('selected').siblings().removeClass('selected');
    var index = $li.index(); //一个jquery元素.index（）就可以知道这个元素排第几
